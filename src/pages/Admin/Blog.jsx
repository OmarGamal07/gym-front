        ...
        {({ values, handleChange, handleSubmit }) => (
          ...
          >
            ...
            <div className="flex flex-col w-3/5   px-5">
              <span className="text-2xl text-right">اضف مدونه</span>
              <span className="text-md text-right text-gray-500">
                اكتب بيانات المدونه حتي تتم اضافتها
              </span>
            ...
            <div className="flex flex-col w-full  px-5">
              ...
              {success&&(
                <div className="text-center text-green-500 font-bold">تم اضافه المدونه بنجاح</div>
              )}
