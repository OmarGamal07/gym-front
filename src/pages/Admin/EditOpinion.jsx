...
const EditOpinion = () => {
  ...
  const handleForm = async() => {
    ...
    {
        blogImg && blogImg.forEach((img) => formData.append("opinionImg", img));
    }
    try {
          ...
          >
            ...
            <div className="flex flex-col w-3/5   px-5">
              ...
              <span className="text-md text-right text-gray-500">
                اكتب بيانات الاراء حتي تتم تعديلها
              </span>
            ...
            <div className="flex flex-col w-full  px-5">
              <span className="text-xl text-right">وصف الرائ</span>
              <span className="text-md text-right text-gray-500">
                أدخل وصف الرائ
              </span>
              <textarea
              ...
              <div className="flex w-full items-center justify-center ">
                ...
                >
                  ...
                  description ? (
                    ...
                    <span>اكمل بيانات الرائ</span>
                  )}
                </button>
              </div>
              <div className="text-center text-red-500 font-bold">{error}</div>
              {success&&(
                <div className="text-center text-green-500 font-bold">تم تعديل الرائ بنجاح</div>
              )}
